  ...
  <div class="record_item">
    ...
    <div class="top_info_div">
      <div class="top_info_item_div">
        <span class="dwjf_span">{{ data.jflslbmc }}</span>
        <span>缴费历史类别</span>
      </div>
      <div class="top_info_item_div">
      ...
      <div class="top_info_item_div">
        <span class="jine_span">{{ data.dwbh }}</span>
        <span>单位编号</span>
      </div>
    </div>
    <!-- 分割线 -->
    ...
    <div class="content_detail_div" v-if="isExtend">
      <key-value-txt title="参保单位名称" :content="data.dwmc"></key-value-txt>
      <key-value-txt
        title="缴费基数"
        :content="getJine(data.jfjs) + '元'"
      ></key-value-txt>
      <key-value-txt
        title="单位缴费额"
        :content="getJine(data.dwjfe) + '元'"
      ></key-value-txt>
      <key-value-txt
        title="发生日期"
